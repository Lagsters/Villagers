...
const DEFAULT_ORDER = [
  G.PLANK, G.STONE, G.SWORD, G.SHIELD, G.SHOVEL, G.HAMMER, G.AXE, G.SAW, G.PICK, G.SCYTHE, G.ROD, G.CLEAVER,
  G.PINCER, G.COAL, G.IRON_ORE, G.STEEL, G.GOLD_ORE, G.GOLD, G.LUMBER, G.FISH, G.BREAD, G.MEAT, G.WHEAT,
  G.FLOUR, G.PIG, G.BOAT,
];
